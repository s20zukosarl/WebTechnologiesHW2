...
function setupIndex() {
  ...
  // load JSON data
  fetch('http://localhost/data/get-top-paintings').then(function (response) {
...
function setupSingle(id) {
  ...
  // load JSON data
  fetch('http://localhost/data/get-painting/' + id).then(function (response) {
    return response.json();
    ...
    // load related books
    fetch('http://localhost/data/get-related-paintings/' + id).then(function (response) {
      return response.json();
    }).then(function (paintings) {
...
function renderIndex(paintings) {
  var i = 0;
  var _iterator = _createForOfIteratorHelper(paintings),
    _step;
  try {
...
function renderRelated(paintings) {
  ...
  var row = document.createElement('div');
  row.classList = 'row mb-5';
  var _iterator2 = _createForOfIteratorHelper(paintings),
    _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var painting = _step2.value;
      // create book div
